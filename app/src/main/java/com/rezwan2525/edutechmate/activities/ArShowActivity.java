...
public class ArShowActivity extends AppCompatActivity implements
    ...
    public void loadModels(String url) {
        WeakReference<ArShowActivity> weakActivity = new WeakReference<>(this);
        ModelRenderable.builder()
                ...
                .build()
                .thenAccept(model -> {
                    ArShowActivity activity = weakActivity.get();
                    if (activity != null) {
